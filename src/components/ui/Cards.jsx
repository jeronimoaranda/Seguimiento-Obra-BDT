...
export const MetricCard = ({ title, value, icon: Icon, color, subtext, percentage, compact }) => (
    <div className="bg-white p-4 rounded-lg shadow-sm border-l-4 relative overflow-hidden group hover:shadow-md transition-all h-full" style={{ borderLeftColor: color }}>
