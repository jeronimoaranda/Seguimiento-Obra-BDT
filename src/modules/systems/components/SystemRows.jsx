...
import { ChevronDown, ChevronRight, Activity, Zap, Wrench, Target, Hammer, Layers, Boxes } from 'lucide-react';

export const TagEditRow = React.memo(({ tagItem, onEdit, skidOptions, almacenOptions, isReadOnly }) => {
...
export const SpecialtyGroup = ({ specialtyName, tags, onEdit, skidOptions, almacenOptions, isReadOnly }) => {
